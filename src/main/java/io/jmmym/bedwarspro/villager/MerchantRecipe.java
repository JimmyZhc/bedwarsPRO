...
public class MerchantRecipe {
  ...
  public MerchantRecipe(Object item1, Object item2, Object reward) {
    this.merchantRecipe = BedwarsPRO.getInstance().getMinecraftServerClass("MerchantRecipe");
    Class isClass = BedwarsPRO.getInstance().getMinecraftServerClass("ItemStack");
    try {
  ...
  public static Class getReflectionClass() {
    return BedwarsPRO.getInstance().getMinecraftServerClass("MerchantRecipe");
  }

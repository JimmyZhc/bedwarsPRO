...
public class WarpPowder extends SpecialItem {
  ...
  public WarpPowder() {
    ...
    this.fullTeleportingTime =
        BedwarsPRO.getInstance().getIntConfig("specials.warp-powder.teleport-time", 6);
  }
  ...
  public void cancelTeleport(boolean removeSpecial, boolean showMessage) {
    ...
    this.teleportingTime =
        (double) BedwarsPRO.getInstance().getIntConfig("specials.warp-powder.teleport-time", 6);
    ...
    if (showMessage) {
      this.player
          .sendMessage(ChatWriter
              .pluginMessage(BedwarsPRO._l(this.player, "ingame.specials.warp-powder.cancelled")));
    }
  ...
  private ItemStack getCancelItemStack() {
    ...
    meta.setDisplayName(BedwarsPRO._l("ingame.specials.warp-powder.cancel"));
  ...
  public void runTask() {
    ...
    this.player.sendMessage(
        ChatWriter.pluginMessage(BedwarsPRO._l(this.player, "ingame.specials.warp-powder.start",
    ...
    this.teleportingTask = new BukkitRunnable() {
      ...
      public boolean showParticle =
          BedwarsPRO.getInstance().getBooleanConfig("specials.warp-powder.show-particles", true);
    ...
    }.runTaskTimer(BedwarsPRO.getInstance(), 0L,

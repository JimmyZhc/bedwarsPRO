...
public class SupportData {
  ...
  public static String getBukkitVersion() {
    return BedwarsPRO.getInstance().getServer().getBukkitVersion();
  }
  ...
  public static File getConfigFile() {
    ...
    try {
      tmp = File.createTempFile("BedwarsPRO-supportdata-config", null);
      config.save(tmp);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public static String getPluginVersion() {
    ...
    return BedwarsPRO.getInstance().getDescription().getVersion();
  }

  public static String[] getPluginVersionArray() {
    return BedwarsPRO.getInstance().getDescription().getVersion().split("-");
  }
  ...
  public static String getPluginVersionType() {
    if (BedwarsPRO.getInstance().getDescription().getVersion().contains("SNAPSHOT")) {
      return "SNAPSHOT";
    }
    return "RELEASE";
  }
  ...
  public static ArrayList<String> getPlugins() {
    ...
    Plugin[] plugins = BedwarsPRO.getInstance().getServer().getPluginManager().getPlugins();
  ...
  public static String getServerVersion() {
    return BedwarsPRO.getInstance().getServer().getVersion();
  }

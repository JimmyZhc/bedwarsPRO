...
public class DebugPasteCommand extends BaseCommand implements ICommand {
  ...
  public DebugPasteCommand(BedwarsPRO plugin) {
    super(plugin);
  }
                ...
                try {
                  ...
                  try {
                    latestLOG = HastebinUtility
                        .upload(new File(BedwarsPRO.getInstance().getDataFolder(),
                            "../../logs/latest.log"));
                  ...
                  b.append("version:\n");
                  b.append("  plugin: ")
                      .append("\"" + BedwarsPRO.getInstance().getDescription().getVersion() + "\"");
                  if (SupportData.getPluginVersionArray().length == 3
                      && !SupportData.getPluginVersionArray()[1].equals("unknown")) {
                    b.append("(https://github.com/BedwarsPRO/BedwarsPRO/tree/"
                  ...
                  b.append("online_mode: ")
                      .append(BedwarsPRO.getInstance().getServer().getOnlineMode())
                      .append('\n');
                  b.append("plugins("
                      + BedwarsPRO.getInstance().getServer().getPluginManager().getPlugins().length
                      + "):");
                  ...
                  b.append("\n# https://github.com/BedwarsPRO/BedwarsPRO/issues");
  ...
  public String getDescription() {
    return BedwarsPRO._l("commands.debugpaste.desc");
  }

  @Override
  public String getName() {
    return BedwarsPRO._l("commands.debugpaste.name");
  }

...
public class RemoveTeamCommand extends BaseCommand {
  ...
  public RemoveTeamCommand(BedwarsPRO plugin) {
    super(plugin);
  }
  ...
  public boolean execute(CommandSender sender, ArrayList<String> args) {
    ...
    if (theTeam == null) {
      sender.sendMessage(
          ChatWriter.pluginMessage(ChatColor.RED + BedwarsPRO._l(sender, "errors.teamnotfound")));
      return false;
    }

    game.removeTeam(theTeam);
    sender.sendMessage(
        ChatWriter.pluginMessage(ChatColor.GREEN + BedwarsPRO._l(sender, "success.teamremoved")));
    return true;
  }
  ...
  public String getDescription() {
    return BedwarsPRO._l("commands.removeteam.desc");
  }

  @Override
  public String getName() {
    return BedwarsPRO._l("commands.removeteam.name");
  }

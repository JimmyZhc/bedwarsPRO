...
public class ListGamesCommand extends BaseCommand {
  ...
  public ListGamesCommand(BedwarsPRO plugin) {
    super(plugin);
  }
  ...
  public boolean execute(CommandSender sender, ArrayList<String> args) {
    ...
    for (Game game : games) {
      ...
      sb.append(ChatColor.YELLOW
          ...
          + BedwarsPRO._l(sender, "sign.gamestate." + game.getState().toString().toLowerCase())
          + ChatColor.YELLOW
          + " - " + BedwarsPRO._l(sender, "sign.players") + ": " + ChatColor.WHITE + "["
          + ChatColor.YELLOW
    ...
    if (showedGames.size() == 0) {
      sb.append(ChatColor.RED + BedwarsPRO._l(sender, "errors.nogames"));
    }
  ...
  public String getDescription() {
    return BedwarsPRO._l("commands.list.desc");
  }

  @Override
  public String getName() {
    return BedwarsPRO._l("commands.list.name");
  }

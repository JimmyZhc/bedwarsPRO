...
public class RegionNameCommand extends BaseCommand implements ICommand {
  ...
  public RegionNameCommand(BedwarsPRO plugin) {
    super(plugin);
  }
  ...
  public boolean execute(CommandSender sender, ArrayList<String> args) {
    ...
    if (name.length() > 15) {
      player.sendMessage(
          ChatWriter
              .pluginMessage(ChatColor.RED + BedwarsPRO._l(player, "errors.toolongregionname")));
      return true;
    }
    ...
    player
        .sendMessage(
            ChatWriter
                .pluginMessage(ChatColor.GREEN + BedwarsPRO._l(player, "success.regionnameset")));
    return true;
  }
  ...
  public String getDescription() {
    return BedwarsPRO._l("commands.regionname.desc");
  }

  @Override
  public String getName() {
    return BedwarsPRO._l("commands.regionname.name");
  }
